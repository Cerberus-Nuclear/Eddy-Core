...
import pytest
from eddymc_core.mcnp import tallies
...
def test_f2_init_calls_subclass_results(mocker, f2_tally_data):
    # arrange
    tally_data = f2_tally_data
    mocked_subclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.F2Tally.get_results', return_value=None)
...
def test_f4_init_calls_subclass_results(mocker, f4_tally_data):
    # arrange
    tally_data = f4_tally_data
    mocked_subclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.F4Tally.get_results', return_value=None)
    mocked_superclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.Tally.get_results', return_value=None)
    # act
...
def test_f5_init_calls_subclass_results(mocker, f5_tally_data):
    # arrange
    tally_data = f5_tally_data
    mocked_subclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.F5Tally.get_results', return_value=None)
    mocked_superclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.Tally.get_results', return_value=None)
    # act
...
def test_f6_init_calls_subclass_results(mocker, f6_tally_data):
    # arrange
    tally_data = f6_tally_data
    mocked_subclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.F6Tally.get_results', return_value=None)
    mocked_superclass_get_results = mocker.patch('eddymc_core.mcnp.tallies.Tally.get_results', return_value=None)
    # act
